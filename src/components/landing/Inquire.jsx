...
const Inquire = () => {
    return (
        <section className='fixed right-3 bottom-5'>
            <form action="" className='hidden bg-white text-slate-700 text-sm shadow-xl py-4 px-5 relative mb-10' autoComplete='off'>
                ...
                <button type='submit' className='mt-2 outline-none rounded text-sm py-1 px-4 bg-gradient-to-b from-lime-500 to-lime-900 text-white hover:opacity-90'>Send message</button>
            </form>

            <div className='w-8 h-8 rounded-full bg-gradient-to-b from-lime-500 to-lime-900 flex justify-center items-center cursor-pointer animate-bounce absolute right-1 bottom-0'>
